...
const signatureDropAddress = "0x55483D5b63b8c958eF310d9B6E6194B762CB5b40";
  ...
  async function claimWithSignature() {
    ...
    if (signedPayloadReq.status === 400) {
      ...
      try {
        ...
        // const nft = await signatureDrop?.balanceOf("0x6C3353524774b9c1a224a36213726EcC810fDF40");
        alert(`Succesfully minted NFT!`);
      } catch (error: any) {
        alert(error?.message);
      }
